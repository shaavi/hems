...
<strong>Error !</strong> User Registration field must not be Empty !</div>';
      return $msg;
...
<strong>Error !</strong> Email already Exists, please try another Email... !</div>';
      ...
      $sql = "INSERT INTO user(name, username, email, password, mobile) VALUES(:name, :username, :email, :password, :mobile)";
      $stmt = $this->db->pdo->prepare($sql);
...
<strong>Error !</strong> Email already Exists, please try another Email... !</div>';
  ...
  <strong>Error !</strong> Invalid email address !</div>';
      ...
      $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  <strong>Error !</strong> Email not Found, use Register email or password please !</div>';
      return $msg;
    } else {
      ...
      if ($chkActive == TRUE) {
        $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Error !</strong> Sorry, Your account is Deactivated</div>';
        return $msg;
      } elseif ($logResult) {
  ...
  public function userDeactiveByAdmin($deactive)
  {
    ...
    if ($result) {
      ...
      Session::set('msg', '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Error !</strong>User account not Deactivated</div>');
  ...
  public function userActiveByAdmin($active)
  {
    ...
    if ($result) {
      ...
      Session::set('msg', '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Error !</strong>User account not activated</div>');
    }
  }
  ...
  <strong>Error !</strong> New password must be at least 6 character</div>';
    ...
    if ($oldPass == FALSE) {
      $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
     <strong>Error !</strong> Old password did not Match</div>';
      return $msg;
    } else {
